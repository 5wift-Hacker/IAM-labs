...
| [Password Management / Access Levels](./entra-id/password-mgmt-access-levels/README.md) | Microsoft Entra ID | Password resets/changes via Graph PowerShell / Role/permission assignment, access level configuration
...
- [ ] Add Conditional Access lab
- [ ] Add PIM (Privileged Identity Management) lab
- [ ] Add Lifecycle Workflows lab
- [ ] Add first Okta lab
- [ ] Add RBAC vs directory roles writeup

---

Feedback and suggestions welcome — always looking to sharpen these labs further.
